...
if __name__ == '__main__':
    ...
    path_file_raw = "module_dataset/dataset/raw_data/vn_hate_speech/train_preprocess_text.csv"
    ...
    path_file_train_augment = "module_dataset/dataset/data_for_train/exp_train_augment.csv"
    ...
    split_train_test(path_file_raw, path_save_data, name_train, name_test, test_size=0.2)

    # augment data
    path_dict_synonym = "module_dataset/dataset/support_data/dict_synonym.json"
    make_data_with_augmentation(path_file_train, path_file_train_augment, path_dict_synonym)
